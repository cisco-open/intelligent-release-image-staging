...
| IOS-XR appmgr agent | The same device image packaged for appmgr on IOS-XR routers: the Cisco 8000 series and the NCS family. It uses the router's network and stages directly to `harddisk:` through a bind mount. |
