...
ALLOWLIST = [
    ...
    # 538 when Task 9 parameterized the fade color (--scroll-fade) and added
    # its explanatory comment above .table-scroll -- same property, re-pinned
    # at its new location.
    ("server/webroot/styles.css", frozenset({538}),
